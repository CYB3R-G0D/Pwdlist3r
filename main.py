...
if __name__ == '__main__':
    ...
    parser.add_argument('-p', '--profiler', action="store_true", help='user password profiler')
    parser.add_argument('-w', '--wordlist', action="store_true", help='wordlist generator')
